<div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom mt-2 ms-2">
    ...
    <?php if ($_COOKIE['login'] != ''){ ?>
        <a class="btn btn-outline-primary ms-2" href="../article.php">Добавить статью</a>
    <?php } ?>
